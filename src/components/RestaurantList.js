...
const RestaurantList = () => {
  ...
  const [lat, setLat] = useState(16.5061743);
  const [lng, setLng] = useState(80.6480153);
        ...
        <div className="location flex flex-wrap gap-2 sm:gap-2 mb-6 mt-3 md:my-3 items-center justify-start">
          ...
          <button
            className={`sm:px-4 sm:py-2 p-2 border-2 ${
              activeLocation === "Hyderabad" ? "bg-[#b6b6b6]" : "bg-white"
            } rounded-md hover:bg-gray-400 hover:text-white`}
            onClick={() =>
              handleLocationClick("Hyderabad", 17.406498, 78.47724389999999)
            }
          >
            Hyd
          </button>
          ...
          <button
            className={`sm:px-4 sm:py-2 p-2 border-2 ${
              activeLocation === "Chennai" ? "bg-[#b6b6b6]" : "bg-white"
            }  rounded-md hover:bg-gray-400 hover:text-white`}
            onClick={() =>
              handleLocationClick("Chennai", 13.0843007, 80.2704622)
            }
          >
            Chennai
          </button>
